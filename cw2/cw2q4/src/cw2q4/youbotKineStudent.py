...
class YoubotKinematicStudent(YoubotKinematicBase):
    def __init__(self):
        ...
        # Set the offset for theta --> This will be updated on 19/11/2021. Feel free to use your own code.
	...
	# --> This will be updated on 19/11/2021. Feel free to use your own code.
